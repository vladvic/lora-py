...
void outputHelp(const char *what) {
  ...
  printf("    Functions:\n");
  printf("               send(netid : <Int>, devaddr : <Int>, port : <Int>, data : <Bytearray>, confirm : <Boolean>)\n");
  printf("         invalidate(deveui : <String>, appeui : <String>)\n");
  printf("\n");
  printf("    Constants:\n");
  printf("               DR0 to DR15, CR4_5 to CR4_8, CLASS_A, CLASS_B, CLASS_C\n");
  printf("\n");
